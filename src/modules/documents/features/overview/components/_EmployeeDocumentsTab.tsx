...
interface Props {
  ...
  permanentData: EmployeeDocumentListItem[];
  permanentTotal: number;
  monthlyData: EmployeeDocumentListItem[];
  monthlyTotal: number;
...
export function _EmployeeDocumentsTab({
  permanentStats,
  monthlyStats,
  generalStats,
  permanentData,
  ...
  return (
    <Tabs value={currentSubTab} onValueChange={handleSubTabChange} className="space-y-4">
      ...
      <TabsContent value="permanent" className="space-y-4">
        <_DocumentsStatsCards stats={permanentStats} showMissingMandatory />
      ...
      <TabsContent value="general" className="space-y-4">
        ...
        <_MultiResourceDocumentsDataTable
          ...
          appliesTo="EMPLOYEE"
          emptyMessage="No hay tipos de documento multirrecurso configurados para empleados"
        />
      </TabsContent>
    </Tabs>
  );
