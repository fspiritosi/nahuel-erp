...
export interface EmployeeDocumentsColumnsPermissions {
  canUpdate: boolean;
  canDelete: boolean;
}
...
interface ColumnsOptions {
  employeeId: string;
  onView: (doc: EmployeeDocumentListItem) => void;
  onDownload: (doc: EmployeeDocumentListItem) => void;
  onDelete: (doc: EmployeeDocumentListItem) => void;
  permissions: EmployeeDocumentsColumnsPermissions;
}
...
export function getColumns({
  ...
  onDelete,
  permissions,
}: ColumnsOptions): ColumnDef<EmployeeDocumentListItem>[] {
  ...
  return [
    // Tipo de documento
    {
      ...
      cell: ({ row }) => (
        <Link
          href={`/dashboard/employees/${employeeId}/documents/${row.original.id}`}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem asChild>
                <Link href={`/dashboard/employees/${employeeId}/documents/${doc.id}`}>
